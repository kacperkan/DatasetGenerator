...
/**
 * @brief Class providing generating of images and its annotation using cropped
 * TS's
 */
class DatasetGeneratorCropped_t : public DatasetGenerator_t {
   ...
   protected:
     ...
     */
    void splitAnnotation(const std::string& s, const char& delim,
                         StrBuffer_t& elems) const;
